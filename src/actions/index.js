...
import { GET_TODO_LIST, GET_TODO_LIST_LOAD_ERROR, GET_TODO_LIST_LOADING } from '../constants/todoConstants';
...
export function getData() {
    return {
        [GET_API]: {
            ...
            // authenticated: true,
            types: [GET_TODO_LIST_LOADING, GET_TODO_LIST, GET_TODO_LIST_LOAD_ERROR],
        }
    }
}
